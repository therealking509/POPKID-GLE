...
if (cmd === "menu") { const start = Date.now(); await m.React('🤖'); const uptimeSeconds = process.uptime(); const hours = Math.floor((uptimeSeconds % (3600 * 24)) / 3600); const minutes = Math.floor((uptimeSeconds % 3600) / 60); const seconds = Math.floor(uptimeSeconds % 60); const uptime = ${hours}h ${minutes}m ${seconds}s;
...
╭───────────────⭓ │ 🤖 ʙᴏᴛ : ᴘᴏᴘᴋɪᴅ-xᴅ │ ⏱️ ʀᴜɴᴛɪᴍᴇ : ${uptime} │ 🌐 ᴍᴏᴅᴇ : public │ 🧩 ᴘʀᴇғɪx : ${prefix} │ 👑 ᴏᴡɴᴇʀ : popkid │ 🛠️ ᴅᴇᴠ : ᴘᴏᴘᴋɪᴅ │ 🧪 ᴠᴇʀ : 2.0.0 ╰───────────────⭓ ━━━━━━━━━━━━━━━━━━ 💥 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙋𝙊𝙋𝙆𝙄𝘿-𝙓𝘿 💥 ━━━━━━━━━━━━━━━━━━
