...
const autolikestatusCommand = async (m, Matrix) => {
  ...
  if (cmd === 'autostatusreact') {
    ...
    if (text === 'on') {
      ...
      responseMessage = "Autostatusreact  has been enabled. The bot will now react to status updates.";
    } else if (text === 'off') {
      config.AUTO_STATUS_REACT = false;
      responseMessage = "Autostatusreact has been disabled. The bot will no longer react to status updates.";
    } else {
